...
class TestRepo(TestBase):
	...
	def _assert_empty_repo(self, repo):
		# test all kinds of things with an empty, freshly initialized repos.
	...
	def test_creation_deletion(self):
		...
		remote = self.rorepo.create_remote("new_remote", "git@server:repos.git")
