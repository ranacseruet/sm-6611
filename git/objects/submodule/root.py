...
class RootModule(Submodule):
	...
	def __init__(self, repo):
		# repos, binsha, mode=None, path=None, name = None, parent_commit=None, url=None, ref=None)
						...
						if not dry_run:
							...
							if rmt_for_deletion is None:
								if len(rmts) == 1:
									...
									raise InvalidGitRepositoryError("Couldn't find original remote-repos at url %r" % psm.url)
