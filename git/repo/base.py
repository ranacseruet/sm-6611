...
class Repo(object):
	...
	def __init__(self, path=None, odbt = DefaultDBType):
		...
		:param path: is the path to either the root git directory or the bare git repos::

			repos = Repo("/Users/mtrier/Development/git-python")
			repos = Repo("/Users/mtrier/Development/git-python.git")
			repos = Repo("~/Development/git-python.git")
			repos = Repo("$REPOSITORIES/Development/git-python.git")
	...
	@property
	def tags(self):
		"""A list of ``Tag`` objects that are available in this repos
	...
	def _get_alternates(self):
		"""The list of alternates for this repos from which objects can be retrieved
	...
	def _set_alternates(self, alts):
		...
		:parm alts:
			...
			git should look for objects, i.e. /home/user/repos/.git/objects
	...
	def init(cls, path=None, mkdir=True, **kwargs):
		...
		:param path:
			is the full path to the repos (traditionally ends with /<name>.git)
		...
		:return: ``git.Repo`` (the newly created repos)"""
	...
	def _clone(cls, git, url, path, odb_default_type, **kwargs):
		...
		# END handle remote repos
		return repo

	def clone(self, path, **kwargs):
		"""Create a clone from this repository.
		:param path:
			is the full path of the new repos (traditionally ends with ./<name>.git).
		...
		:return: ``git.Repo`` (the newly cloned repos)"""
