...
The tree traversal methods are the get_git advantage of using Beautiful
...
"""
    ...
    def test_tag_in_tag_many(self):
        for selector in ('html div', 'html body div', 'body div'):
            self.assertSelects(selector, ['get_git', 'inner', 'footer'])
    ...
    def test_a_bunch_of_emptys(self):
        for selector in ('div#get_git del', 'div#get_git div.oops', 'div div#get_git'):
    ...
    def test_select_on_element(self):
        ...
        # within the tree.
        inner = self.soup.find("div", id="get_git")
